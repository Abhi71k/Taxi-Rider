...
import com.colours.cabs.adapter.CategoryVehicleAdapter;
import com.colours.cabs.controller.AppController;
import com.colours.cabs.directionhelpers.FetchURL;
import com.colours.cabs.model.CategoryVehiclePojo;
...
import com.colours.cabs.settings.ConnectionDetector;
...
//            return;
//        }
        bottomSheetFragmentBookingDriver = new BottomSheetFragmentBookingDriver(activity, loc1, loc2, distance, durationDriving, String.valueOf(categoryVehiclePojo.getId()), depart_name, destination_name, categoryVehiclePojo.getPrice(),categoryVehiclePojo.gettwokmcharg(),categoryVehiclePojo.getafterdis()
    ...
    private static void getStaticMap(){
        if(points.size() != 0){
            ...
            final String STATIC_MAP_API_ENDPOINT = "http://maps.googleapis.com/maps/api/staticmap?size=1000x300&markers="+loc1.getLatitude()+","+loc1.getLongitude()+"|"+loc2.getLatitude()+","+loc2.getLongitude()+"&path=color:0x000000|"+path+"&sensor=false&key=AIzaSyDwiLf7G1dR_ZskhWU1Rb9siTFOBoSrPmA";
                                        ...
                                        if(taxi.getString("libelle").equals("Mini")){
                                            if(i == 0){
                                                albumList_category_vehicle.add(new CategoryVehiclePojo(taxi.getInt("id"),taxi.getString("libelle"),taxi.getString("image"),
                                                        durationBicicling,taxi.getString("prix"),taxi.getString("twokmcharg"),taxi.getString("afterdis"),"no",taxi.getString("statut_commission"),taxi.getString("commission"),taxi.getString("type"),taxi.getString("statut_commission_perc"),taxi.getString("commission_perc"),taxi.getString("type_perc")));
                                            }else{
                                                albumList_category_vehicle.add(new CategoryVehiclePojo(taxi.getInt("id"),taxi.getString("libelle"),taxi.getString("image"),
                                                        durationBicicling,taxi.getString("prix"),taxi.getString("twokmcharg"),taxi.getString("afterdis"),"no",taxi.getString("statut_commission"),taxi.getString("commission"),taxi.getString("type"),taxi.getString("statut_commission_perc"),taxi.getString("commission_perc"),taxi.getString("type_perc")));
                                            }
                                            ...
                                            if(i == 0){
                                                albumList_category_vehicle.add(new CategoryVehiclePojo(taxi.getInt("id"),taxi.getString("libelle"),taxi.getString("image"),
                                                        durationDriving,taxi.getString("prix"),taxi.getString("twokmcharg"),taxi.getString("afterdis"),"no",taxi.getString("statut_commission"),taxi.getString("commission"),taxi.getString("type"),taxi.getString("statut_commission_perc"),taxi.getString("commission_perc"),taxi.getString("type_perc")));
                                            }else{
                                                albumList_category_vehicle.add(new CategoryVehiclePojo(taxi.getInt("id"),taxi.getString("libelle"),taxi.getString("image"),
                                                        durationDriving,taxi.getString("prix"),taxi.getString("twokmcharg"),taxi.getString("afterdis"),"no",taxi.getString("statut_commission"),taxi.getString("commission"),taxi.getString("type"),taxi.getString("statut_commission_perc"),taxi.getString("commission_perc"),taxi.getString("type_perc")));
                                            }
